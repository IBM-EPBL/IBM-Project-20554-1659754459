...
<body>
  <nav class="navbar sticky-top  navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
    <a class="navbar-brand" href="#">Personal Expense</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#display.html">About us</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="today.html">Date & Day</a>
            
            <a class="dropdown-item" href="year.html">Month</a>
  ...
  <a class="btn btn-primary dropdown-toggle "href="#" id="navbarDropdown"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" style="color: crimson;" href="/logout">Log-Out <i class="fa fa-sign-out" aria-hidden="true"></i></a>
          </div>
        </li>
        ...
        <div class="col-md-6">
            ...
            <form action="/addexpense" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="Expense Name" id="Expenser Name">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="payment mode" id="payment mode">
                        ...
                        <option name="Pay as Cash" value="Pay as Cash">Pay as Cash</option>
                        ...
                        <option name="Netbanking" value="Netbanking">Netbanking</option>
            ...
            <div  style="position: relative; left: 590px; top: -460px;" class="imagge">
                <img width="90%" height="90%" src="https://img.freepik.com/free-vector/family-budget-planning-abstract-concept-vector-illustration-best-economic-decisions-personal-budget-strategy-family-income-expenses-management-financial-household-plan-abstract-metaphor_335657-1723.jpg?size=338&ext=jpg&ga=GA1.2.581727004.1667494309">
